...
New-Item -Path "C:\ProgramData\TMT\OutlookWeb" -ItemType Directory

# URL of the PNG image you want to download
$imageURL = "https://raw.githubusercontent.com/medteamadmins/MasterScript/main/OutlookIcon.ico"

# Specify the local path where you want to save the downloaded PNG file
$localFilePath = "C:\ProgramData\TMT\OutlookWeb\OutlookIcon.ico"
...
$shortcutPath = [System.IO.Path]::Combine([System.Environment]::GetFolderPath("Desktop"), "Outlook Web App.lnk")

$WshShell = New-Object -ComObject WScript.Shell
$shortcut = $WshShell.CreateShortcut($shortcutPath)
$shortcut.TargetPath = $chromeExePath
$shortcut.IconLocation = "C:\ProgramData\TMT\OutlookWeb\OutlookIcon.ico"
$shortcut.Arguments = $targetURL
$shortcut.Save()
New-Item -Path "C:\ProgramData\TMT\OutlookWeb\Successful.txt"