...
New-Item -Path "C:\ProgramData\TMT\Office365Web" -ItemType Directory

# URL of the PNG image you want to download
$imageURL = "https://raw.githubusercontent.com/medteamadmins/MasterScript/main/Office365.ico"

# Specify the local path where you want to save the downloaded PNG file
$localFilePath = "C:\ProgramData\TMT\Office365Web\OfficeIcon.ico"
...
$targetURL = "https://portal.office.com"
$shortcutPath = [System.IO.Path]::Combine([System.Environment]::GetFolderPath("Desktop"), "Office 365 Portal.lnk")

$WshShell = New-Object -ComObject WScript.Shell
$shortcut = $WshShell.CreateShortcut($shortcutPath)
$shortcut.TargetPath = $chromeExePath
$shortcut.IconLocation = "C:\ProgramData\TMT\Office365Web\OfficeIcon.ico"
$shortcut.Arguments = $targetURL
$shortcut.Save()
New-Item -Path "C:\ProgramData\TMT\Office365Web\Successful.txt"